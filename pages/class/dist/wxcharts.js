...
function drawYAxisTitle(title, opts, config, context) {
  ...
  context.beginPath();
  context.setFontSize(config.fontSize);
  context.setFillStyle(opts.yAxis.titleFontColor || '#fff');
...
function drawXAxis(categories, opts, config, context) {
  ...
  context.beginPath();
  context.setStrokeStyle(opts.xAxis.gridColor || "#fff");
  ...
  if (config._xAxisTextAngle_ === 0) {
    context.beginPath();
    context.setFontSize(config.fontSize);
    context.setFillStyle(opts.xAxis.fontColor || '#999999');
    categories.forEach(function(item, index) {
...
function drawYAxisGrid(opts, config, context) {
  ...
  context.beginPath();
  context.setStrokeStyle(opts.yAxis.gridColor || "#FFF");
  context.setLineWidth(1);
  points.forEach(function(item, index) {
...
function drawYAxis(series, opts, config, context) {
  ...
  context.beginPath();
  context.setFontSize(config.fontSize);
  context.setFillStyle(opts.yAxis.fontColor || '#fff');
